...
export default function AddClient({onCancel}) {
    ...
    return (
        <div>
            <div className="mt-14 space-y-12">
                ...
                <div
                    ...
                    <p className="mt-1 text-sm leading-6 text-gray-600">Add
                        information about the new client</p>
            ...
            <div
                ...
                <button
                    type="button"
                    disabled={((email && !validateEmail(email)) || !phone || !validatePhone(phone) || !firstName || !lastName)}
